...
[![GitHub](https://img.shields.io/badge/github-full--statck--skills%2Fdevops-skills-green.svg)](https://github.com/full-statck-skills/devops-skills)
...
```bash
npx skills add full-statck-skills/devops-skills
```

或按需安装特定技能：

```bash
npx skills add full-statck-skills/devops-skills --skill <skill-name>
```
...
```bash
git clone https://github.com/full-statck-skills/devops-skills.git
